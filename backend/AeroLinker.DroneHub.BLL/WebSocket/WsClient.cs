...
namespace AeroLinker.DroneHub.BLL.WebSocket
{
    /// <summary>
    /// WebSocket client
    /// </summary>
    ...
    public class WsClient : HttpClient, IWebSocket
    {
        ...
        public List<DroneTelemetryDto> flightLog_;
        private bool _stop;

        protected WsSession? mainSession_;
        ...
        public virtual void OnMainSessionReceived(byte[] buffer, long offset, long size)
        {
