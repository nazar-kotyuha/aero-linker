...
import { CreateDroneModalComponent } from './create-drone-modal/create-drone-modal.component';
...
@NgModule({
    declarations: [MainComponent, MainHeaderComponent, NavbarHeaderComponent, CreateDroneModalComponent],
